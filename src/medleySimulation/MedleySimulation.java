...
public class MedleySimulation {
	...
	static CyclicBarrier boom = new CyclicBarrier(numTeams);
	...
	public static void setupGUI(int frameX,int frameY) {
		...
		startB.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e)  {
				...
				//NOTIFY TEAM THREADS TO BEGIN SIMULATION
				synchronized(SwimTeam.begin)
				{
					SwimTeam.begin.set(true);
					SwimTeam.begin.notifyAll();
				}
